...
class PorterStemmer {
    ...
    private String stemWord(String word) {
        ...
        // noun → root
        if (word.endsWith("ation") && word.length() > 6) return word.substring(0, word.length() - 5) + "e";
        if (word.endsWith("tion") && word.length() > 5) return word.substring(0, word.length() - 4) + "e";
        ...
        if (word.endsWith("ate") && word.length() > 4) return word.substring(0, word.length() - 3);
        if (word.endsWith("ize") && word.length() > 4) return word.substring(0, word.length() - 3);
